...
def copy_image_to_folder(src_folder: str,  target_path: str, Specify_Clusters: list, epoch: int, Num_of_cluster: int, clust_folder: dict, dict_error_clust_folder:dict, dict_image_text_gt: dict, dict_image_text_pred_train: dict):
